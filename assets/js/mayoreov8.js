        ...
        $.getJSON('/mayoreo/carrito/contents', function(data_dt){
            ...
            $('.eliminar_ajax').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    $('#myModal').modal('hide');
                    _open_modal_alert('<div class="alert alert-success" role="alert">Producto eliminado</div>', 'https://www.massivepc.com/mayoreo/?cb='+cacheBuster2);
            ...
            $('#btn_sig_1').on('click', function(e) {
                ...
                $('.modal-body').load('/mayoreo/pago/ajax'+ '?rand=' + new Date().getTime(), function(responseTxt, statusTxt, xhr) {
                    vl_1++;

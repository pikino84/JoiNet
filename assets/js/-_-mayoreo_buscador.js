        ...
        $.getJSON('/mayoreo/carrito/contents', function(data_dt){
            ...
            if (p_precio > 9999) {//p_distribuidor
                ...
                if(p_distribuidor >= 500){
                    ...
                    $('#d_d_n').html('<strong>Gratis</strong>');
                }else{
                    $('#total_j').text(p_distribuidor + 120);
                    $('#d_d_n').html('$120.00');
                }
                //$('#total_j').text(p_distribuidor + 120);//Gratis día del niño
                ...
                //$('#total_j').text(p_mayoreo + 120);//Gratis día del niño
                //$('#pagar_j,#actualizar_j').removeClass('disabled');
                $('#msg_empty_cart').hide();
                $('#btn_pagar').removeAttr('disabled');
                $('.list_pm_j').show();
                ...
                //$('#total_j').text(p_precio);//Gratis día del niño
                if(p_precio >= 500){
                ...
                //$('#total_j').text(p_precio + 120);//Gratis día del niño
                //if ($('#total_j').text() <= 120) {

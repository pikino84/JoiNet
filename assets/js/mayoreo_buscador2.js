...
/*******************************/
 $('.opnctr').on('click', function(e){
            ...
            $.ajax({
                ...
                url        : 'https://www.massivepc.com/mayoreo/distribuidor/get_categories/?cb=' + cacheBusterGeneral,
            ...
            if(continue_e == 1){
                if(items_c > 0){
                    ...
                    $.ajax({
                        ...
                        dataType   : 'jsonp',
                        crossDomain:true,
                        url        : 'https://www.massivepc.com/mayoreo/carrito/add_ajax_e?cb=' + cacheBusterGeneral,
                    }).done(function(drv) {
                        $('.cantidad').val('');
                        get_content_cart();
                    });
...
/*******************************/
    ...
    function get_totales(){
        $.ajax({
            ...
            dataType   : 'jsonp',
            crossDomain: true,
            url        : 'https://www.massivepc.com/mayoreo/carrito/get_tti?cb=' + cacheBusterGeneral,
        }).done(function(er) {
    ...
    function edit_qty(rowid,qty){
        $.ajax({
            ...
            url        : 'https://www.massivepc.com/mayoreo/carrito/editar_ajax?cb=' + cacheBusterGeneral,
        }).done(function(er) {
            get_content_cart();
    ...
    $('#validar_mail').click(function() {
        ...
        if (regex.test(correo_boletin.trim())) {
            $.ajax({
                ...
                url        : 'https://www.massivepc.com/mayoreo/boletin/validar/?cb=' + cacheBusterGeneral,
    ...
    var write_r = '<form id="datos_personales" class="form-signin" action="" method="post">';
                ...
                /**********/
                    $.ajax({
                        ...
                        dataType   : 'jsonp',
                        crossDomain: true,
                        url        : 'https://www.massivepc.com/mayoreo/carrito/get_cookies_datos/?cb=' + cacheBusterGeneral
                ...
                $('#datos_personales').on('submit', function(e){
                    ...
                    $.ajax({
                        ...
                        url        : 'https://www.massivepc.com/mayoreo/pago/verificar?cd='+cacheBusterGeneral,
                                        ...
                                        nr_ += '<div class="panel panel-default">';
                                            nr_ += '<div class="panel-body">';
                                                nr_ += '<div class="radio">';
                                                    ...
                                                    nr_ += 'PayPal (Aplica 24hrs hábiles). *Se aplicara un 4% adicional de comisión';
                                                    nr_ += '</label>';
                                                nr_ += '</div>';
                        ...
                        $('#frm_pago').on('submit', function(e){
                            ...
                            $.ajax({
                                ...
                                url        : 'https://www.massivepc.com/mayoreo/pago/'+metodo_pago+'?cd='+cacheBusterGeneral,
...
/*Colocar pedido OFF*/
    ...
    function myCall(id_product) {
        var output;
        var request = $.ajax({
            url        : 'https://www.massivepc.com/mayoreo/carrito/get_name_product',
            type       : "GET",            
            dataType   : "jsonp",
            crossDomain: true,
            async      : false,
        ...
        $.getJSON('/mayoreo/carrito/contents', function(data_dt){
            ...
            $('.eliminar_ajax').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url        : 'https://www.massivepc.com/mayoreo/carrito/delete_ajax/?cb=' + cacheBusterGeneral,
                }).done(function(dc) {

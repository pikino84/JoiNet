...
/*******************************/
 $('.opnctr').on('click', function(e){
            ...
            $.ajax({
                ...
                url: '/mayoreo/distribuidor/get_categories_fix/?cb=' + cacheBusterGeneral,
            ...
            if(continue_e == 1){
                if(items_c > 0){
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        url     : '/mayoreo/carrito/add_ajax_fixed?cb=' + cacheBusterGeneral,
                    }).done(function(drv) {
                        $('.cantidad').val('');
                        get_content_cart();
                    });
...
/*******************************/
    ...
    function get_totales(){
        $.ajax({
            ...
            method: 'POST',
            dataType: 'json',
            url: '/mayoreo/carrito/get_tti_fix?cb=' + cacheBusterGeneral,
        }).done(function(er) {
    ...
    function edit_qty(rowid,qty){
        $.ajax({
            ...
            url: '/mayoreo/carrito/editar_ajax_fix?cb=' + cacheBusterGeneral,
        }).done(function(er) {
            get_content_cart();
    ...
    var write_r = '<form id="datos_personales" class="form-signin" action="" method="post">';
                ...
                write_r += '<div class="col-md-12">';
                    ...
                    write_r += '<div id="fact_data" class="col-md-6" style="display:none;">';
                        ...
                        write_r += '<div class="form-group has-feedback">';
                            write_r += '<label class="control-label" for="f_transferencia">Últimos 4 dígitos de la cuenta Bancaria desde donde se realiza la transferencia.</label>';
                    ...
                    write_r +='<div class="col-md-12">';
                        ...
                        write_r += '<div class="checkbox">';
                        write_r += '<label>';
                        write_r += '<input id="btn_aviso_privacidad" type="checkbox"> He leído y estoy de acuerdo con el <a target="_blank" href="http://www.massivepc.com/aviso-de-privacidad.php">Aviso de Privacidad</a> y <a target="_blank" href="http://www.massivepc.com/b_envios.php#T%C3%A9rminos%20de%20env%C3%ADo">Términos de envío</a>';
                        write_r += '</label>';
                        write_r += '</div>';
                        write_r +='<div class="row">';
...
/*Colocar pedido OFF*/
    ...
    function get_content_cart(){
        ...
        $.getJSON('/mayoreo/carrito/contents', function(data_dt){
            ...
            //write_r += '<span class="label_d text-right">Envío por DHL (Hasta 20 kg):</span> <span style="width:75px;display: inline-block;">$150.00 </span><hr>';
            ...
            if (p_precio > 4999) {//p_distribuidor
                ...
                /*if(p_distribuidor >= 500){
                    ...
                    //$('#total_j').text(p_distribuidor + 150);
                    $('#total_j').text(imp_tot2 + 150);//APLICAR PORCENTAJE DE DESCUENTO 16-01-2017
                    $('#d_d_n').html('$150.00');
                //}

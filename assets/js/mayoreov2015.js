...
$(document).ready(function() {
    ...
    $('.dfsdf').on('click', function(e) {
        ...
        $.ajax({
            ...
            write_r += '</tr>';
            write_r += '<tr>';
            write_r += '<td colspan="4"><a id="destroy" class="btn btn-danger" disabled="disabled">Eliminar todo <span class="glyphicon glyphicon-arrow-right"></span></a></td> <td colspan="3" class="text-right"><a id="btn_sig_1" class="btn btn-primary" disabled="disabled">Siguiente <span class="glyphicon glyphicon-arrow-right"></span></a></td>';
            write_r += '</tr>';
            write_r += '</table>';
                                ...
                                $('#continuar').on('click', function(e) {
                                    ...
                                    $(this).attr('disabled','disabled');
                                        ...
                                        $.ajax({
                                            ...
                                            $.getJSON('/mayoreo/pago/clear_cart?cb=' + cacheBuster4, function( json ) {

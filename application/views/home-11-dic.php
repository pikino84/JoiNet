...
<head>
    ...
    <style type="text/css">
		...
		html,body{
			overflow-x:hidden;
            /*background: url(https://www.massivepc.com/mayoreo/assets/img/bg_buen_fin.gif?dfdf=dfdf) repeat;*/
		}
		.container{
			padding:0px;
		}
...
<div class="container">
        <table id="table1">
            <tr>
                ...
                <td id="td300">
                    <span><br> 
                        Suscríbete a nuestro boletín para <br>obtener promociones especiales <a class="detalle_total">--</a><br>
    ...
    <a target="_blank" href="https://www.massivepc.com/buenfin/">
        <img id="img_principal" class="img-responsive" src="<?=base_url()?>assets/img/productos-joinet_dic.jpg" />
    </a>
                            ...
                            <div class="row">
                               <div class="col-md-6">
                                    <ul class="f-sm text-center list-unstyled">
                                        ...
                                        <li>333955-4197<small><strong>Marisol</strong></small></li>

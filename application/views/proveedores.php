...
<head>
    ...
    <link href="https://www.massivepc.com/mayoreo/assets/css/bootstrap-chosen.css" rel="stylesheet" type="text/css" media="screen" />
    	...
    	<link rel="stylesheet" href="<?=base_url()?>assets/css/skins/facebook.css">
...
<select id="proveedor_id" name="proveedor_id" class="chosen-select" data-placeholder="PROVEEDOR" tabindex="-1">
 ...
 <option <?=($proveedor_id == '       223') ? 'selected=""' : '' ?> value="       223">HELERGON</option> -->
...

            {
                ...
                echo '<a target="_blank" href="https://www.massivepc.com/mayoreo/proveedores/codigo/'.$provmd5.'/'.trim($proveedor_id).'?rnd='.md5(time()).'">https://www.massivepc.com/mayoreo/proveedores/codigo/'.$provmd5.'/'.trim($proveedor_id).'?rnd='.md5(time()).'</a>';

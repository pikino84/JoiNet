...
<head>
    ...
    <title>Massive Pc - Venta de tablets baratas en Guadalajara</title>
...
<div id="dialog_boletin" title="Error!" style="display:none;">
    ...
    <div style=" width:1160px; margin:auto;">
        <table style="margin:auto; width:900px;">
            ...
            <tr>
                <td colspan="2">
                    <h3 style="text-align:center; font-size:30px; margin-bottom:20px; color:#F72327;">Lista de precios de Mayoreo</h3>
                </td>
            </tr>
        </table>
                ...
                <table class="table_1">
                    ...
                    <tr>
                        ...
                        <td class="p5" style="text-align:center; background:#ffffff; width:70px;">
							<img alt="Fabricante" src="http://www.massivepc.com/images/<?=$product->manufacturers_image?>" height="30" width="60">
                        </td>
                        <td class="p5" style="text-align: center; background:#ffffff; width:118px;">
                            <a target="_blank" href="http://www.massivepc.com/-p-<?=$product->products_id?>.html">
                            	<img src="http://www.massivepc.com/images/<?=$product->products_image?>" alt="<?=url_title($product->products_name,' ',FALSE)?>"/>
                            </a>
                        </td>
        ...
        <h3 style="color:#F72327; text-align:center; font-size:30px; margin-bottom:20px;">Historial de boletines</h3>
        <div id="boletines">
        	<ul>
        ...
        <div style="clear:both;"></div>
        <br>
        <h3 style="color:#F72327; text-align:center; font-size:30px; margin-bottom:20px;">Boletín de la computación de Abril </h3>
        <table style="margin:auto; width:1160px; border:solid thin #000000;">
            <tr style="background:#fff;">
                <td style="border:solid thin #000000;"><img alt="Boletín Mayoreo" src="http://massivepc.com/mayoreo/assets/uploads/boletin/0.jpg?r=45"></td>
                <td style="border:solid thin #000000;"><img alt="Boletín Mayoreo" src="http://massivepc.com/mayoreo/assets/uploads/boletin/1.jpg?r=45"></td>
            </tr>
            <tr>
                <td style="border:solid thin #000000;"><img alt="Boletín Mayoreo" src="http://massivepc.com/mayoreo/assets/uploads/boletin/2.jpg?r=45"></td>
                <td style="border:solid thin #000000;"><img alt="Boletín Mayoreo" src="http://massivepc.com/mayoreo/assets/uploads/boletin/3.jpg?r=45"></td>
            </tr>
        </table>
        <br>
        <table style="border:solid thin #000000; margin:auto; width:774px; height:330px;">
            <tr style="background:#fff;">
                <td>
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3732.8793486440263!2d-103.34723199999995!3d20.674487000000006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8428b1fa80084ef9%3A0x195b5fdea7d0a86c!2sJoinet!5e0!3m2!1ses!2smx!4v1414014584784" style="border:0; width:746px; height:300px;"></iframe>
                </td>
            </tr>
        </table>
        <!--<br>
        ...
        <table style="font-family: Arial, Helvetica, sans-serif;  font-size:12px; margin:auto; width:774px; height:200px; border:solid thin #000000;">
            <tr style="text-align:center; background:#f2f2f2;">
                <td style="width:385px; height:300px;border-right:solid thin #000000;">
                    <a class="fancybox" href="http://massivepc.com/mayoreo/m3.jpg">
                        <img src="http://massivepc.com/mayoreo/m1.jpg" width="384" height="300" alt="" />
                    </a>
                </td>
                <td style="width:387px; height:300px;">
                    <a class="fancybox" href="http://massivepc.com/mayoreo/m4.jpg">
                        <img src="http://massivepc.com/mayoreo/m2.jpg" width="387" height="300" alt="" />
                    </a>
                </td>
            </tr>
            </table>

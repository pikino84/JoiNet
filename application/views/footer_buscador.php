...
<style type="text/css">
    ...
    #solo_ofertas2{
        ...
        <ul id="solo_ofertas2" class="list-unstyled" style="margin-left: 20%;">



            <?$count_ofertas = count($solo_ofertas)?>



            <? $co = round($count_ofertas / 4)?>
            ...
            <? foreach($solo_ofertas as $ofertas):?>
                ...
                <? if($i==7 || $i==14 || $i==21 || $i==28 || $i==35 || $i==42 ){?>
                    ...
                    <ul id="solo_ofertas2" class="list-unstyled">
...
<div class="container bs-docs-container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 text-center">
                    ...
                    <img class="img-thumbnail img-responsive" src="https://www.massivepc.com/img/tienda/1.jpg?abc=123" alt="" />
                ...
                <div class="col-md-3 text-center">
                    ...
                    <img class="img-thumbnail img-responsive" src="https://www.massivepc.com/img/tienda/2.jpg?abc=123" alt="" />
                ...
                <div class="col-md-3 text-center">
                    ...
                    <img class="img-thumbnail img-responsive" src="https://www.massivepc.com/img/tienda/6.jpg?abc=123" alt="" />
                ...
                <div class="col-md-3 text-center">
                    ...
                    <img class="img-thumbnail img-responsive" src="<?=base_url()?>assets/img/baner4.jpg?abc=123" alt="" />
            ...
            <div class="row">
                ...
                <div class="col-md-3 text-center">
                    ...
                    <img class="img-thumbnail img-responsive" src="<?=base_url()?>assets/img/baner5.jpg?abc=123" alt="" />
                ...
                <div class="col-md-3 text-center">
                    ...
                    <img class="img-thumbnail img-responsive" src="<?=base_url()?>assets/img/baner6.jpg?abc=123" alt="" />
                ...
                <div class="col-md-3 text-center">
                    ...
                    <img class="img-thumbnail img-responsive"  src="https://www.massivepc.com/mayoreo/assets/img/tienda-1.jpg?abc=123" alt="" />
                ...
                <div class="col-md-3 text-center">
                    ...
                    <img class="img-thumbnail img-responsive" src="https://www.massivepc.com/mayoreo/assets/img/tienda-2.jpg?abc=123" alt="" />
        ...
        <!--<div class="container bs-docs-container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <iframe class="mapa" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d762.4002781343423!2d-103.3473259144148!3d20.674662993356883!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x92cf34df8c5e5db5!2sMASSIVE+PC!5e0!3m2!1ses-419!2smx!4v1457645131746" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
        ...
        <!--<div class="container bs-docs-container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <img class="img-thumbnail img-responsive" src="<?=base_url()?>assets/img/parabus02.jpg?abcd=123456" />
                    ...
                    <div class="panel panel-info h_190">
                      ...
                      <div class="panel-body">
                        ...
                        <address>
                            ...
                            Av. Ramón Corona No. 148 Esq. López Cotilla<br>

                            Entre López Cotilla y Av. Juárez<br>
                      ...
                      <div class="panel-body">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="text-left"><strong>Teléfonos:</strong></td>
...
<!--
                            ...
                            <tr>
                                ...
                                <td>&nbsp;Lunes a Domingo 10:00 am – 7:30 pm <br> &nbsp;Domingo 10:30 am – 6:30 pm</td>
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel-info h_190">
                      ...
                      <div class="panel-heading">
                        ...
                        <h3 class="panel-title"><i class="fa fa-whatsapp"></i> Contacto personalizado ventas</h3>
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-6">
                                    ...
                                    <ul class="f-sm text-center list-unstyled">
                                        <li>331231-2455<small><strong>Sergio Mendoza</strong></small></li>
                                        <li><!--
                                            331051-9340<small><strong>Daniel Sanchez</strong></small>
                                            -->
                                        </li> 
                                        
<!--                                        <li>333440-0228<small><strong>Sergio Mendoza</strong></small></li>
                                        <li>331360-7921<small><strong>Daniel Sanchez</strong></small></li>

                                        <li>333470-4783<small><strong>Virginia Mora</strong></small></li>
                                        <li>331786-0862<small><strong>Berenice Parra</strong></small></li>                                      --> 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ul class="f-sm text-center list-unstyled">
                                        <li>332280-0469<small><strong>Juan Pablo</strong></small></li>
                                        <li>331125-4398<small><strong>Hernan Cortez</strong></small></li>    
<!--                                        <li>332175-0706<small><strong>Denisse Mendivil</strong></small></li>                                        
-->
                                    </ul>
                    ...
                    <div class="panel panel-info m-h-225">
                      ...
                      <div class="panel-body">
                        ...
                        <ul style="padding:0 0 0 13px; margin:0px;">
                            ...
                            <li>Envíos a toda la república Mexicana por DHL $170 pesos hasta 20 Kg.</li>

                            <li>Tiempo de entrega de 2 a 5 días dependiendo el destino.</li>
                    ...
                    <div class="panel panel-info m-h-225">
                      ...
                      <div class="panel-body">
                        ...
                        <ul style="padding:0 0 0 13px; margin:0px;">
                            ...
                            <li>El periodo de garantía es de 30 días en accesorios generales y 3 meses en equipos electrónicos las siguientes marcas joinet, coby, adata, zenek, kingston y kimtigo.</li>
...
A nombre de: URQUIZA Y GARCIA LOGISTICA SA DE CV
	...
	<!--						
                            ...
                            <div class="col-md-4">
                                <img src="<?=base_url()?>assets/img/logo-banamex.jpg?asdsad=fff" height="30px"/><br><br>
...
-->				
                    ...
                    <div class="panel panel-info">
                      ...
                      <div class="panel-body">
                        ...
                        <ul>
                            ...
                            <!--<li>Manejamos factura y garantía en todos nuestros productos<a href="https://www.massivepc.com/mayoreo/?mostrar=agotados">.</a></li>-->
        ...
        <hr style="background:#D9EDF7; border:solid 1px #D9EDF7; margin-top:0px; margin-bottom:0px;">
            ...
            <div class="row">
                ...
                $fecha_f = $dias[date('w')]." ".date('d')." de ".$meses[date('n')-1]. " del ".date('Y');
                ...
                <div class="col-md-5" style="font-size:11px;">
                    ...
                    <a target="_blank" href="http://www.massivepc.com/b_bienvenido.php">Bienvenido</a> | <a target="_blank" href="http://www.massivepc.com/b_quienessomos.php">Quienes somos</a> | <a target="_blank" href="http://www.massivepc.com/b_formasdepago.php">Formas de pago</a> | <a target="_blank" href="http://www.massivepc.com/b_seguridad.php">Seguridad</a> | <a target="_blank" href="http://www.massivepc.com/b_garantia.php">Garantia</a> | <a target="_blank" href="http://www.massivepc.com/b_politicasdeventa.php">Politicas de Venta</a> <br> <a target="_blank" href="http://www.massivepc.com/b_envios.php">Envios</a> |

                    <a target="_blank" href="http://www.massivepc.com/b_ayuda.php">Ayuda</a><br>

                    Todos los precios son mostrados en pesos mexicanos por default y con I.V.A.<br>

                    Copyright © 2016 Massive PC. Todos los derechos reservados.<br>

                    <?=$fecha_f?>. 39103190 peticiones desde viernes 07 julio, 2006<br>
                ...
                <div class="col-md-2" style="padding-top:10px;">
                    ...
                    <a target="_blank" href="https://sellosdeconfianza.org.mx/MuestraCertificado.php?NUMERO_SERIE=MD_v101"><img src="https://www.massivepc.com/images/sellodeconfianza.jpg"></a>
                ...
                <div class="col-md-2 text-right">
                    ...
                    <!--<a target="_blank" href="http://www.symantec.com/es/mx/ssl-certificates-sem/"><img src="http://www.massivepc.com/mayoreo/assets/img/norton.gif"/></a>-->
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="titulo_v" style="display:none;">
  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <img class="img-responsive" src="/mayoreo/Logo-Massive-Mayoreo.png" style="max-height: 80px;" /> <h3 class="modal-title text-primary" id="titulo_v"> </h3>

      </div>

      <div id="content_cart_details" class="modal-body">
...
<div id="blueimp-gallery" class="blueimp-gallery">
    ...
    <script src="/mayoreo/assets/js/jquery.typewatch.js"></script>
    ...
    <script src="/mayoreo/assets/js/bootstrap-switch.min.js"></script>
...
var google_conversion_id = 959246840;
...
<script>
  ...
  })(window, document, '_gscq','script','//widgets.getsitecontrol.com/109324/script.js');
</script>
<noscript>

<div style="display:inline;">

<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/959246840/?value=0&amp;guid=ON&amp;script=0"/>

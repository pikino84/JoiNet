...
.relative{
    ...
    .icon_youtube{
        display   : block;
        background: url("https://www.massivepc.com/mayoreo/assets/img/youtube.jpg");
        width     : 20px;
        height    : 14px;
        position  : absolute;
        margin    : auto;
        ...
        <div class="row" style="margin-top: 5px;">
            ...
            <table id="listado_productos" class="table table-bordered table-hover" style="background:#fff;">
                    ...
                    <tr id="t_<?=$product->products_id?>">
                        ...
                        <td class="text-center">
                            ...
                            <?
                                if($product->products_id == '17508'){
                                    ...
                                    /*************/
                                    if($product->id_categoria == '44' || $product->id_categoria == '35' || $product->products_id == '13706' || $product->products_id == '13707' || $product->products_id == '15495'){
                                        if($product->sae_exist <= '0'){
                                            echo 'Agotado';
                                            $ex = 0;
                                        }else{
                        ...
                        <td class="text-center">
                            <?
                            if($product->id_categoria == '44' || $product->id_categoria == '35' || $product->products_id == '13706' || $product->products_id == '13707' || $product->products_id == '14190' || $product->products_id == '15495'){
                                if($product->sae_exist <= '0'){
                                        ?>
                        ...
                        <td class="text-center">
                            <?
                                if($product->products_id == '17508'){//
                                    ...
                                    /*************/
                                    if($categorie->id_categoria == '44' || $categorie->id_categoria == '35' || $product->products_id == '13706' || $product->products_id == '13707' || $product->products_id == '15495'){
                                        if($product->sae_exist <= '0'){
                                            echo 'Agotado';
                                            $ex = 0;
                                        }else{

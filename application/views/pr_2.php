...
<div class="container-fluid">
	...
	<div class="row">
				<div class="col-sm-6">
					Nombre <span id="counter_js"></span>
			...
			<?
				if(isset($costo_nacional) && isset($precio_pu)){
					$rpu1       = $precio_pu - $costo_nacional;
					$rpu2       = $rpu1 / $costo_nacional;
					$utilidad_p = $rpu2 * 100; if($utilidad_p>=1){$cpu='btn-success';}else{$cpu='btn-danger';}
				}else{$utilidad_p ='';$cpu=''; }

				if(isset($costo_nacional) && isset($precio_ma)){
					$rma1       = $precio_ma - $costo_nacional;
					$rma2       = $rma1 / $costo_nacional;
					$utilidad_m = $rma2 * 100; if($utilidad_m>=1){$cma='btn-success';}else{$cma='btn-danger';}
				}else{$utilidad_m ='';$cma=''; }

				if(isset($costo_nacional) && isset($precio_di)){
					$rdi1       = $precio_di - $costo_nacional;
					$rdi2       = $rdi1 / $costo_nacional;
					$utilidad_d = $rdi2 * 100; if($utilidad_d>=1){$cdi='btn-success';}else{$cdi='btn-danger';}
				}else{$utilidad_d ='';$cdi=''; }

				if(isset($costo_nacional) && isset($precio_x_producto)){
					$rpxp1       = $precio_x_producto - $costo_nacional;
					$rpxp2       = $rpxp1 / $costo_nacional;
					$utilidad_pxp = $rpxp2 * 100; if($utilidad_pxp>=1){$cpxp='btn-success';}else{$cpxp='btn-danger';}
				}else{$utilidad_pxp ='';$cpxp=''; }
				

				$uti_dis_nac_class = '';
				$uti_dis_nac       = '';

				if($costo_nacional != '' && $precio_di != ''){

					$uti_dis_nac = round($precio_di - $costo_nacional);

					if($uti_dis_nac >= 1){
						$uti_dis_nac_class = 'btn-success';
		        	}else{
		        		$uti_dis_nac_class = 'btn-danger';
		        	}

		        	$uti_dis_nac_7 = $precio_di * .93;
		        	$uti_dis_nac_7 = round($uti_dis_nac_7 - $costo_nacional);

		        	if($uti_dis_nac_7 >= 1){
						$uti_dis_nac_class_7 = 'btn-success';
		        	}else{
		        		$uti_dis_nac_class_7 = 'btn-danger';
		        	}

		        	$uti_dis_nac_5 = $precio_di * .95;
		        	$uti_dis_nac_5 = round($uti_dis_nac_5 - $costo_nacional);

		        	if($uti_dis_nac_5 >= 1){
						$uti_dis_nac_class_5 = 'btn-success';
		        	}else{
		        		$uti_dis_nac_class_5 = 'btn-danger';
		        	}

				}

				if($costo_nacional != '' && $precio_ma != ''){

					$uti_ma_nac = round($precio_ma - $costo_nacional);

					if($uti_ma_nac >= 1){
						$uti_ma_nac_class = 'btn-success';
		        	}else{
		        		$uti_ma_nac_class = 'btn-danger';
		        	}

				}

				if($costo_nacional != '' && $precio_pu != ''){

					$uti_pu_nac = round($precio_pu - $costo_nacional);

					if($uti_pu_nac >= 1){
						$uti_pu_nac_class = 'btn-success';
		        	}else{
		        		$uti_pu_nac_class = 'btn-danger';
		        	}

				}

				if($costo_nacional != '' && $precio_x_producto != ''){

					$uti_pxp_nac = round($precio_x_producto - $costo_nacional);

					if($uti_pxp_nac >= 1){
						$uti_pxp_nac_class = 'btn-success';
		        	}else{
		        		$uti_pxp_nac_class = 'btn-danger';
		        	}
			...
			<div class="row">
				<div class="col-sm-4">
					Publico <span id="utilidad_p" class="<?=$cpu?>">Utilidad:<?=round($utilidad_p)?>% </span><span id="uti_pu_nac" class="<?=$uti_pu_nac_class?>"> $<?=$uti_pu_nac?> MXN</span>
					<div class="form-group">
						<input class="form-control" type="text" id="precio_pu" name="precio_pu" value="<?=(isset($precio_pu)) ? $precio_pu : '' ?>" />
					</div>
				</div>
				<div class="col-sm-4">
					Mayoreo <span id="utilidad_m" class="<?=$cpu?>">Utilidad:<?=round($utilidad_m)?>% </span><span id="uti_ma_nac" class="<?=$uti_ma_nac_class?>"> $<?=$uti_ma_nac?> MXN</span>
					<div class="form-group">
						<input class="form-control" type="text" id="precio_ma" name="precio_ma" value="<?=(isset($precio_ma)) ? $precio_ma : '' ?>" />
					</div>
				</div>
				<div class="col-sm-4">
					Distribuidor <span id="utilidad_d" class="<?=$cpu?>">Utilidad:<?=round($utilidad_d)?>% </span><span id="uti_dis_nac" class="<?=$uti_dis_nac_class?>"> $<?=$uti_dis_nac?> MXN</span>
					<div class="form-group">
						<input class="form-control uti_dis_nac" type="text" id="precio_di" name="precio_di" value="<?=(isset($precio_di)) ? $precio_di : '' ?>" />
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					Precio por producto por caja <span id="utilidad_pxp" class="<?=$cpxp?>">Utilidad:<?=round($utilidad_pxp)?>% </span><span id="uti_pxp_nac" class="<?=$uti_pxp_nac_class?>"> $<?=$uti_pxp_nac?> MXN</span>
					<div class="form-group">
					    <div class="input-group">
			...
			<div class="row">
				<div class="col-sm-4">
					Utilidad 5%: <span id="uti_dis_nac_5" class="<?=$uti_dis_nac_class_5?>">$<?=$uti_dis_nac_5?> MXN</span>
				</div>
				<div class="col-sm-4">
					Utilidad 7%: <span id="uti_dis_nac_7" class="<?=$uti_dis_nac_class_7?>">$<?=$uti_dis_nac_7?> MXN</span>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-4">
					Costo Nacional
					<div class="form-group">
						<input class="form-control uti_dis_nac" type="text" id="costo_nacional" name="costo_nacional" value="<?=(isset($costo_nacional)) ? $costo_nacional : '' ?>" />
					</div>
				</div>
				...
				<div class="col-sm-4">
					Costo ¥
					<div class="form-group">
						<input class="form-control" type="text" name="costo" value="<?=(isset($costo)) ? $costo : '' ?>" />
					</div>
				</div>
				...
				<div class="col-sm-4">
					Costo USD
					<div class="form-group">
						<input class="form-control" type="text" name="costo_usd" value="<?=(isset($costo_usd)) ? $costo_usd : '' ?>" />
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-3">
					Remate
					<div class="form-group">
						<select class="form-control" name="remate">
				...
				<div class="col-sm-3">
					Nuevo
					<div class="form-group">
							<select class="form-control" name="nuevo">
...
<option value=""></option>
 <option <?=($proveedor == '       221') ? 'selected=""' : '' ?> value="       221">XH</option> 
 ...
 <option <?=($proveedor == '       207') ? 'selected=""' : '' ?> value="       207">NOVEDADES DE ORIENTE</option>  
...
<div class="form-group">
                        <select class="form-control" name="proveedor1" id="proveedor1" tabindex="2" >
                                <option value=""></option>
 <option <?=($proveedor1 == '       221') ? 'selected=""' : '' ?> value="       221">XH</option> 								
 ...
 <option <?=($proveedor1 == '       207') ? 'selected=""' : '' ?> value="       207">NOVEDADES DE ORIENTE</option> 
...
<div class="form-group">
                        <select class="form-control" name="proveedor2" id="proveedor2" tabindex="2">
                                <option value=""></option>
 <option <?=($proveedor2 == '       221') ? 'selected=""' : '' ?> value="       221">XH</option> 								
 ...
 <option <?=($proveedor2 == '       207') ? 'selected=""' : '' ?> value="       207">NOVEDADES DE ORIENTE</option> 
 ...
 <option <?=($proveedor2 == '        78') ? 'selected=""' : '' ?> value="        78">SUMEX</option> 
				...
				<div class="col-sm-6">
					Costo
					<div class="form-group">
						<input class="form-control" type="text" name="costo_nacional2" value="<?=(isset($costo_nacional2)) ? $costo_nacional2 : '' ?>" />
					</div>
				</div>
			</div>
...
<div class="form-group">
                        <select class="form-control" name="proveedor3" id="proveedor3" tabindex="2">
                                <option value=""></option>
 <option <?=($proveedor3 == '       221') ? 'selected=""' : '' ?> value="       221">XH</option> 								
 ...
 <option <?=($proveedor3 == '       207') ? 'selected=""' : '' ?> value="       207">NOVEDADES DE ORIENTE</option> 
 ...
 <option <?=($proveedor3 == '        78') ? 'selected=""' : '' ?> value="        78">SUMEX</option> 
				...
				<div class="col-sm-6">
					Costo
					<div class="form-group">
						<input class="form-control" type="text" name="costo_nacional3" value="<?=(isset($costo_nacional3)) ? $costo_nacional3 : '' ?>" />
					</div>
				</div>
			</div>			
...
<div class="form-group">
			...
			<div class="row">
				<div class="col-sm-6">
					Stock min.
					<div class="form-group">
						<input class="form-control" type="text" name="stock_min" value="<?=(isset($stock_min)) ? $stock_min : '' ?>" />
					</div>
				</div>
				<div class="col-sm-6">
					Stock max.
					<div class="form-group">
						<input class="form-control" type="text" name="stock_max" value="<?=(isset($stock_max)) ? $stock_max : '' ?>" />
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(function(){
        ...
        $('.uti_dis_nac').keyup(function(e){

			var pu        = $('#precio_pu').val();
			var ma        = $('#precio_ma').val();
			var dist      = $('#precio_di').val();
			var pxp      = $('#precio_x_producto').val();
			var nac       = $('#costo_nacional').val();
			var total_pu  = pu - nac ;
			var total_ma  = ma - nac ;
			var total_dis = dist - nac ;
			var total_pxp = pxp - nac ;
        	...
        	$('#uti_pu_nac').text(' $'+total_pu+' MXN ');
        	$('#uti_ma_nac').text(' $'+total_ma+' MXN ');
        	$('#uti_dis_nac').text(' $'+total_dis+' MXN ');
        	$('#uti_pxp_nac').text(' $'+total_pxp+' MXN ');

        	if(total_pu >= 1){
        		$('#uti_pu_nac').removeClass('btn-danger');
				$('#uti_pu_nac').addClass('btn-success');
        	}else{
        		$('#uti_pu_nac').removeClass('btn-success');
        		$('#uti_pu_nac').addClass('btn-danger');
        	}

        	if(total_ma >= 1){
        		$('#uti_ma_nac').removeClass('btn-danger');
				$('#uti_ma_nac').addClass('btn-success');
        	}else{
        		$('#uti_ma_nac').removeClass('btn-success');
        		$('#uti_ma_nac').addClass('btn-danger');
        	}

        	if(total_dis >= 1){
        		$('#uti_dis_nac').removeClass('btn-danger');
				$('#uti_dis_nac').addClass('btn-success');
        	}else{
        		$('#uti_dis_nac').removeClass('btn-success');
        		$('#uti_dis_nac').addClass('btn-danger');
        	}

        	if(total_pxp >= 1){
        		$('#uti_pxp_nac').removeClass('btn-danger');
				$('#uti_pxp_nac').addClass('btn-success');
        	}else{
        		$('#uti_pxp_nac').removeClass('btn-success');
        		$('#uti_pxp_nac').addClass('btn-danger');
        	}

        	$('#uti_dis_nac_7').text(' $'+total_7.toFixed(2)+' MXN ');

        	if(total_7 >= 1){
        		$('#uti_dis_nac_7').removeClass('btn-danger');
				$('#uti_dis_nac_7').addClass('btn-success');
        	}else{
        		$('#uti_dis_nac_7').removeClass('btn-success');
        		$('#uti_dis_nac_7').addClass('btn-danger');
        	}

        	$('#uti_dis_nac_5').text(' $'+total_5.toFixed(2)+' MXN ');

        	if(total_5 >= 1){
        		$('#uti_dis_nac_5').removeClass('btn-danger');
				$('#uti_dis_nac_5').addClass('btn-success');
        	}else{
        		$('#uti_dis_nac_5').removeClass('btn-success');
        		$('#uti_dis_nac_5').addClass('btn-danger');
        	}

        	utilidad_nacional_modif('#precio_pu', '#utilidad_p');
        	utilidad_nacional_modif('#precio_ma', '#utilidad_m');
        	utilidad_nacional_modif('#precio_di', '#utilidad_d');
        	utilidad_nacional_modif('#precio_x_producto', '#utilidad_pxp');

        });


        utilidad_nacional('#precio_pu', '#utilidad_p');
        utilidad_nacional('#precio_ma', '#utilidad_m');
        utilidad_nacional('#precio_di', '#utilidad_d');
        utilidad_nacional('#precio_x_producto', '#utilidad_pxp');

	    function utilidad_nacional(actual,utilidad_l){

			$(actual).keyup(function (e) {

				var costo_nacional = $('#costo_nacional').val();
				var precio         = $(actual).val();
				
				var resultado1     = precio - costo_nacional;
				var resultado2     = resultado1 / costo_nacional;
				var resultado3     = resultado2 * 100;

				if(costo_nacional != ''){
					if(resultado3 <= 0){
						$(utilidad_l).removeClass('btn-success');
						$(utilidad_l).addClass('btn-danger');
					}else{
						$(utilidad_l).removeClass('btn-danger');
						$(utilidad_l).addClass('btn-success');
					}

					$(utilidad_l).html('Utilidad: '+Math.round(resultado3)+'%');
				}
	    ...
	    function utilidad_nacional_modif(actual,utilidad_l){

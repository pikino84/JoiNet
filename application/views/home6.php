                    ...
                    <tr id="t_<?=$product->products_id?>">
                        ...
                        <td>
                            <a href="javascript:void(0);" onclick="window.open('/galeriam.php?products_id=<?=$product->products_id?>', '_blank', 'width=800,height=900,scrollbars=yes,status=yes,resizable=yes,screenx=0,screeny=0');">
                                <img class="img-thumbnail" src="/images/<?=$product->products_image?>" alt="" width="80px" height="80px"/> 
                                <? /*<img class="img-thumbnail" src="http://104.238.78.74/cdn/images/thumb/<?=$product->products_image?>" alt="" width="80px" height="80px"/>*/?>
                            </a>
                        </td>
                        <td class="text-center">
                            <?
                        	...
                        	<?
								/*if($product->agotado=='1'){
									...
									if($product->sae_exist <= '0'){
										?>
									   <input class="form-control input-sm cantidad" type="text" placeholder="Cantidad" disabled/>
                        	           <a href="#" data-id="<?=$product->products_id?>" data-imagen="<?=$product->products_image?>" data-price="<?=$con_iva?>" data-mayoreo="<?=$product->precio_mayoreo?>" data-distribuidor="<?=$product->precio_distribuidor?>" data-name="<?=url_title($product->products_name,' ',FALSE)?>" class="btn btn-xs btn-primary disabled">Agregar</a>
										<?
									}else{
										?>
		                              <input class="form-control input-sm cantidad" type="text" placeholder="Cantidad" />
...
<div style="clear:both;"></div>
        ...
        <div id="publicidad">
        	<ul>
				<li><a target="_blank" href="http://www.massivepc.com/mayoreo/assets/uploads/publicidad/80.jpg">Jwatch</a></li>
                <li><a target="_blank" href="http://www.massivepc.com/mayoreo/assets/uploads/publicidad/81.jpg">J5 quad core</a></li>
                <li><a target="_blank" href="http://www.massivepc.com/mayoreo/assets/uploads/publicidad/82.jpg">J9 dual core</a></li>
                <li><a target="_blank" href="http://www.massivepc.com/mayoreo/assets/uploads/publicidad/83.jpg">J90 dual core</a></li>
                <li><a target="_blank" href="http://www.massivepc.com/mayoreo/assets/uploads/publicidad/85.jpg">Jgamers dual core</a></li>
                <li><a target="_blank" href="http://www.massivepc.com/mayoreo/assets/uploads/publicidad/866.jpg">Jpocket plus</a></li>
                <li><a target="_blank" href="http://www.massivepc.com/mayoreo/assets/uploads/publicidad/87.jpg">Lampara led touch</a></li>
                <li><a target="_blank" href="http://www.massivepc.com/mayoreo/assets/uploads/publicidad/88.jpg">Gamepad Dual</a></li>
                <li><a target="_blank" href="http://www.massivepc.com/mayoreo/assets/uploads/publicidad/89.jpg">Wintel</a></li>
			...
			<ul class="b_col2">
                ...
                <li><a target="_blank" href="http://www.massivepc.com/mayoreo/assets/uploads/publicidad/35.jpg">Jmobile quad core</a></li>
        ...
        <br>
            ...
            <table class="table table-bordered">
                <tr>
                    <td>
    					<img src="<?=base_url()?>assets/img/baner1.jpg" alt="" />
                    </td>
                    <td>
    					<img src="<?=base_url()?>assets/img/baner2.jpg" alt="" />
                    </td>
                    <td class="last">
    					<img src="<?=base_url()?>assets/img/baner3.jpg" alt="" />
                    </td>
                </tr>
            </table>
            ...
            <tr>
            	<td colspan="3">
                	<img src="<?=base_url()?>assets/img/parabus02.jpg" />
                </td>
            </tr>

...
<div class="container">
    ...
    <a target="_blank" href="http://www.massivepc.com/JOINET-m-297.html">
        <img id="img_principal" class="img-responsive" src="<?=base_url()?>assets/img/productos-joinet.jpg" />
    </a>
<br>
...
<form id="f_agregar" method="post" action="<?=base_url()?>carrito/agregar_s">
    <input id="set_data" name="set_data" />
</form>
    ...
    $(function(){
        ...
        $('.dfsdf').on('click', function(e) {
            ...
            $('#set_data').val(myJsonString);

            $('#f_agregar').submit();

            //location.href = 'set_data=' + myJsonString;

...
<head>
    ...
    <style type="text/css">
        ...
        aside a.list-group-item.active_cl{
...
<body>
  ...
  <a id="btn_sweet_cat" class="btn btn-danger"><i class="glyphicon glyphicon-menu-left"></i> Categorias</a>

    <aside>
        <? foreach($categories as $categorie):?>
            <? //if($categorie->id_categoria == 45){ $cl_act = 'active_cl';}else{ $cl_act = ''; }?>
            <a class="filter_cat list-group-item <?/*=$cl_act*/?>" data-cat="<?=$categorie->id_categoria?>" href="#<?=url_title($categorie->categoria)?>|<?=$categorie->id_categoria?>">
                <? /*<span class="badge"><?=$this->products_model->count_products(array('fk_categoria'=>$categorie->id_categoria))?></span>*/?>
                <?=$categorie->categoria?>
            </a>
        <? endforeach?>
    </aside>
                    ...
                    <tr id="t_<?=$product->products_id?>">
                        ...
                        <td class="text-center">
                            ...
                            <?
                                ...
                                //echo $categorie->id_categoria;

                                if($categorie->id_categoria == '35' || $product->products_id == '13706' || $product->products_id == '13707'){
                               ...
                               <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ul class="f-sm text-center list-unstyled">
                                        ...
                                        <li>331854-2361<small><strong>Diego</strong></small></li>
...
<div id="modal_alert" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  ...
  <div class="modal-dialog modal-sm">
    ...
    <script src="/mayoreo/assets/js/func2016.js?<?=md5(time())?>=<?=md5(time())?>"></script>
    ...
    $(function(){
        ...
        $('#btn_sweet_cat').on('click', function(e){
            e.preventDefault();
            if($('#btn_sweet_cat').hasClass('active')){
                $(this).animate({right:-110});

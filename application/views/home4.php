...
<div class="container">
    ...
    <br><br>
    <h5 class="text-center" style="text-decoration: underline;">Para actualizar la página presione <b>Shift + F5</b></h5>
                    ...
                    <div class="panel panel-info m-h-225">
                      ...
                      <div class="panel-body">
                        ...
                        <ul style="padding:0 0 0 13px; margin:0px;">
                            <li>Envíos a toda la república Mexicana por Estafeta $120 pesos hasta 10 Kg.</li>
                            <li>Tiempo de entrega de 1 a 5 días dependiendo el destino.</li>
                            <li>No manejamos envíos exprés.</li>
                        </ul>
                        <div class="row">
                            <div class="col-md-12">
                                <img class="img-responsive" src="<?=base_url()?>assets/img/estafeta.png?dd=87"/>
                            </div>
                        </div>

...
<form id="datos_personales" class="form-signin" style="width:400px; margin:auto;">
    ...
    <div class="text-right">
        <button id="continuar" type="submit" class="btn btn-sm btn-primary verify_disabled" disabled="disabled">Colocar pedido <i class="glyphicon glyphicon-chevron-right"></i> </button>
    </div>

...
class Prv2 extends CI_Controller {
	...
	public function index(){
		...
		foreach ($prov as $k => $v) {
			...
			$productos = $this->products_model->get_products(array('proveedor'=> $v->proveedor));
			$p         = trim($v->proveedor);
			$sumado2   = 0;
            
            echo '<tr><td>'.$proveedores[$p].'</td>';
            ...
            $sumado1 += $sumado2;
            echo '<td>$'.number_format($sumado2).'</td></tr>';
            
		}

		echo '<tr><td>Total:</td><td>$'.number_format($sumado1).'</td></tr>';

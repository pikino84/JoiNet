...
<html lang="en">
    ...
    <script>
		$(function(){
			...
			$('#set_mailchimp').on('click', function(e){
				...
				$.getJSON('/ci/panel/set_mailchimp_batch2',function(data){
					
					setTimeout(function() {
						  location.href='http://massivepc.com/ci/panel/mail_list2/mailchimp';
					}, 2000);
  ...
  <body role="document">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li><a href="http://massivepc.com/ci/panel/mail_list">Correos Boletín</a></li>
            <li class="active"><a href="http://massivepc.com/ci/panel/mail_list2">Correos Registro</a></li>
            <li class="active"><a href="http://massivepc.com/ci/panel/mail_list2">Correos Registro</a></li>
          </ul>
    ...
    <?=$this->benchmark->elapsed_time('codigo_inicio', 'codigo_fin')?>
